...
from core.common import (ButtonHandler, Emoji, NitroConfirmFake,
                         SelectMenuHandler, hexColors, Others, MAIN_ID)
...
class MiscCMD(commands.Cog):
    def __init__(self, bot: commands.Bot):
        ...
        self.whitelistedRoles = [MAIN_ID.r_codingClub, MAIN_ID.r_debateClub, MAIN_ID.r_musicClub, MAIN_ID.r_cookingClub,
                                 MAIN_ID.r_chessClub, MAIN_ID.r_bookClub, MAIN_ID.r_advocacyClub, MAIN_ID.r_speechClub]
    ...
    async def countban(self, ctx, member: discord.Member, *, reason = None):
        ...
        if member.id == ctx.author.id:
            embed = discord.Embed(title = "Unable to CountBan this User", description = "Why are you trying to CountBan yourself?",
                                  color = hexColors.red_error)
            return await ctx.send(embed = embed)
        ...
        if NoCount not in member.roles:
            try:
                ...
                embed = discord.Embed(title = "Count Banned!",
            ...
            try:
                ...
                embed = discord.Embed(title = "Count Unbanned!",
    ...
    async def ping(self, ctx):
        ...
        pingembed.set_author(name = "Timmy", url = Others.timmyLaptop_png, icon_url = Others.timmyHappy_png)
    ...
    async def kill(self, ctx):
        embed = discord.Embed(title = "Confirm System Abortion", description = "Please react with the appropriate emoji to confirm your choice!",
        ...
        try:
            ...
            if str(reaction.emoji) == "❌":
                ...
                embed = discord.Embed(title = "Initiating System Exit...", description = "Goodbye!",
                                      color=discord.Colour.dark_orange())
                message = await ctx.send(embed = embed)
    ...
    async def gitpull(self, ctx, mode = "-a"):
        ...
        embed = discord.Embed(title = "GitHub Local Reset", description = "Local Files changed to match Timmy/main",
