...
class GSuiteLogin(commands.Cog):
    ...
    async def GSuiteVerify(self, interaction: discord.Interaction):
        ...
        if (
            ...
            embed = discord.Embed(title="GSuite Verification",
            ...
            embed.add_field(name="Getting Error Code '403: org_internal'?",
            ...
            try:
                ...
                if (
                    ...
                    try:
                        ...
                        if firstname == "SS" or firstname == "PS":
                            ...
                            embed = discord.Embed(title="Authentication Successful",
                            ...
                            embed = discord.Embed(title="GSuite Authentication",
                                                  description=f"{member.mention} has successfully authenticated with "
                                                              f"their GSuite account.",
                                                  color=discord.Color.green())
                            embed.add_field(name="Verification Details",
                                            value="**Name:** {}\n**Email:** {}\n**Date:** {} EST".format(
                ...
                await dm_channel.send("Looks like you didn't respond in time, please try again later!")

    @commands.command()
    @is_botAdmin
    async def pasteGSuiteButton(self, ctx):
        embed = discord.Embed(title="Alternate Verification Method",
