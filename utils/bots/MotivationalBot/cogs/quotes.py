...
class Quotes(commands.Cog):
    ...
    async def quotesend(self, ctx):
        ...
        embed = discord.Embed(title = "1) What will you be Sending in?",
        ...
        if int(answer1.content) in [1, 2]:
            embed = discord.Embed(title = f"2) Send in your {self.inputdict[int(answer1.content)]}",
            ...
            if query.exists():
                embed = discord.Embed(title = "ERROR: Code 1",
            ...
            embed = discord.Embed(title = f"3) Confirm your {self.inputdict[int(answer1.content)]}",
