...
class MainID:
    ...
    ch_senior_mods = int(ConfigCatClient.MAIN_ID_CC.get_value("ch_seniormods", 878792926266810418))
    ch_moderators = int(ConfigCatClient.MAIN_ID_CC.get_value("ch_moderators", 786068971048140820))
    ch_muted_chat = int(ConfigCatClient.MAIN_ID_CC.get_value("ch_mutedchat", 808919081469739008))
    ch_mod_logs = int(ConfigCatClient.MAIN_ID_CC.get_value("ch_modlogs", 863177000372666398))
    ch_tutoring = int(ConfigCatClient.MAIN_ID_CC.get_value("ch_tutoring", 865716647083507733))
    ch_transcript_logs = int(ConfigCatClient.MAIN_ID_CC.get_value("ch_transcriptlogs", 767434763337728030))
    ch_action_logs = int(ConfigCatClient.MAIN_ID_CC.get_value("ch_actionlogs", 767206398060396574))
    ch_mod_commands = int(ConfigCatClient.MAIN_ID_CC.get_value("ch_modcommands", 786057630383865858))
    ch_control_panel = int(ConfigCatClient.MAIN_ID_CC.get_value("ch_controlpanel", 843637802293788692))
    ch_start_private_vc = int(ConfigCatClient.MAIN_ID_CC.get_value("ch_startprivatevc", 784556875487248394))
    ch_announcements = int(ConfigCatClient.MAIN_ID_CC.get_value("ch_announcements", 763121175764926464))
    ch_mod_announcements = int(ConfigCatClient.MAIN_ID_CC.get_value("ch_modannouncements", 887780215789617202))
...
class SETID:
    ...
    ch_college_acceptance = int(ConfigCatClient.SET_ID_CC.get_value("ch_college_acceptance", 955960683785236540))
    r_hr_staff = int(ConfigCatClient.HR_ID_CC.get_value("r_hrstaff", 861856418117845033))
